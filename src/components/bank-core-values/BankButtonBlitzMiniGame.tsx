...
const BankButtonBlitzMiniGame = ({ onGameEnd }: BankButtonBlitzMiniGameProps) => {
  ...
  return (
    <div className="bank-button-blitz-page" style={{ minHeight: 'auto', background: 'transparent' }}>
        <div className="game-container" style={{ height: '600px', maxHeight: '600px', width: '100%', maxWidth: '480px', margin: 'auto', position: 'relative', boxShadow: 'none', background: 'linear-gradient(180deg, #f8fafc 0%, #e2e8f0 100%)' }}>
